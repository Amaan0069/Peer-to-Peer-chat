  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-blue-200">
      <div className="bg-white p-8 rounded shadow-md w-96 min-h-[500px] flex flex-col justify-center relative">
        {/*Same as Login pages(Dots concept) */}
        ...
        <h2 className="text-2xl mb-6 text-center flex items-center justify-center">
          <img src="src/assets/Banner.jpg" alt="Logo" className="w-8 h-8 mr-2" />
          chat
        </h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <input 
              ...
              className="w-full border border-gray-500 p-2 rounded placeholder-gray-500 text-[0.8rem]"
              required 
            />
          </div>
          <div className="mb-4">
            <input 
              ...
              onChange={handleChange}
              className="w-full p-2 rounded placeholder-gray-400 text-[0.8rem] border border-gray-500 "
              required 
            />
          </div>
          <div className="mb-4">
